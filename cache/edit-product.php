                  ...
                  <div class="col-12">
                    ...
                    <form method="POST" action="">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="productName" class="form-control" id="productName" placeholder="Enter Product name" value="<?php echo $product['product_name'] ?>" required>
                      </div>
                      <div class="form-group">
                        <label for="productDesc">Product Description</label>
                        <textarea name="productDesc" class="form-control" id="productDesc" rows="3"> <?php echo $product['product_description'] ?> </textarea>
                      </div>
                      <div class="form-group">
                        <label for="productCostPrice">Product Cost Price</label>
                        <input type="text" name="productCostPrice" class="form-control" id="productCostPrice" placeholder="Enter Product Cost Price" value="<?php echo $product['cost_price'] ?>" required>
                      </div>
                      <div class="form-group">
                        <label for="productSellingPrice">Product Selling Price</label>
                        <input type="text" name="productSellingPrice" class="form-control" id="productSellingPrice" placeholder="Enter Product Selling Price" value="<?php echo $product['selling_price'] ?>" required>
                      </div>
                      <div class="form-group">
                        <label for="productDiscountedPrice">Product Discounted Price</label>
                        <input type="text" name="productDiscountedPrice" class="form-control" id="productDiscountedPrice" placeholder="Enter Product Discounted Price" value="<?php echo $product['discounted_price'] ?>" required>
                      </div>
                      <div class="form-group">
                        <label for="productQuantity">Product Quantity in Stock</label>
                        <input type="text" name="productStock" class="form-control" id="productStock" placeholder="Enter Product Quantity in Stock" value="<?php echo $product['stock'] ?>" required>
                      </div>
